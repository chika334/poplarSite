...
import hero1 from '../../../assets/images/hero-bg/hero-6.jpg';
    ...
    <>
      <div className="hero-wrapper bg-white bg-composed-wrapper">
        <div className="flex-grow-1 w-100 d-flex align-items-center">
          <div
            className="bg-composed-wrapper--image opacity-9 bg-composed-filter-rm"
            style={{ backgroundImage: 'url(' + hero1 + ')' }}
          />
          <div className="bg-composed-wrapper--content align-self-center p-4 p-xl-5">
            <Container className="pb-5 py-lg-5 text-center">
              <div className="mb-4">
                <div className="badge badge-danger mb-3 h-auto py-2 px-4 font-size-xs badge-pill font-weight-normal">
                  Included
                </div>
                    ...
                    <div className="card-img-wrapper rounded">
                      <div
                        ...
                        <div className="card-badges card-badges-top">
                          <div className="badge-pill badge badge-success">
                            Active
                          </div>
                        </div>
                      </div>
