                          ...
                          <div className="p-4">
                            <div className="d-block d-xl-flex">
                              ...
                              <div className="pl-0 pl-xl-3">
                                ...
                                <p className="mb-0 text-black-50">
                                  Fully coded, perfectly responsive on all
                                  screen sizes. Start working on your project
                                  today!
                                </p>
                              </div>
                            </div>
                          ...
                          <div className="p-4">
                            <div className="d-block d-xl-flex">
                              ...
                              <div className="pl-0 pl-xl-3">
                                ...
                                <p className="mb-0 text-black-50">
                                  All components from the General dashboard
                                  template can be used in the individual
                                  applications pages, without modifications.
                                </p>
                              </div>
                            </div>
                          </div>
