          ...
          <div className="promo-section-buttons">
            ...
            <Tooltip arrow title="View documentation" placement="left">
              <Button
                ...
                href="https://docs.uifort.com/bamburgh-react-messenger-application-material-ui-pro-docs"
                rel="noopener"
                target="_blank">
                <FontAwesomeIcon
                  icon={['far', 'life-ring']}
            ...
            <Tooltip arrow title="View product details" placement="left">
              <Button
                ...
                href="https://uifort.com/template/bamburgh-react-messenger-application-material-ui-pro"
                rel="noopener"
                target="_blank">
                <FontAwesomeIcon
