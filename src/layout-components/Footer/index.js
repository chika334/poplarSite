    ...
    <>
      <div
        ...
        <div className="app-footer--second">
          <span>Bamburgh React Messenger Application with Material-UI PRO</span>{' '}
...
const mapStateToProps = (state) => ({
  footerShadow: state.content.footerShadow,
  footerBgTransparent: state.content.footerBgTransparent
});
